...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\TripType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\TripType']) ? $this->services['AppBundle\Form\TripType'] : ($this->services['AppBundle\Form\TripType'] = new \AppBundle\Form\TripType())) && false ?: '_'};
